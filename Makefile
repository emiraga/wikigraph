...
all: bin/generate_graph bin/process_graph
...
bin/process_graph: process_graph.cpp sqlparser.h config.h
	mkdir -p bin
	g++ $(cflags) process_graph.cpp $(redisobj) -o bin/process_graph
